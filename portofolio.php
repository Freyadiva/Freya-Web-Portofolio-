...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <div class="container-fluid">
      ...
      <div
        ...
        <div class="navbar-nav ml-auto">
          ...
          <a href="portofolio.php" class="nav-item nav-link active">Portfolio</a>
  ...
  <div class="portfolio" id="portfolio">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <ul id="portfolio-filter">
            ...
            <li data-filter=".filter-1">Editing</li>
            <li data-filter=".filter-2">Uni Project</li>
            <li data-filter=".filter-3">Programming</li>
          </ul>
        </div>
      </div>
      <div class="row portfolio-container">
        ...
        // Query untuk mengambil data dari tabel portfolio
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="col-lg-4 col-md-6 col-sm-12 portfolio-item ' . htmlspecialchars($row['filter_class']) . ' wow fadeInUp" data-wow-delay="' . htmlspecialchars($row['delay']) . '">';
            ...
            echo '<a class="btn show-description" data-title="' . htmlspecialchars($row['description']) . '">+</a>';
            echo '</div>';
            echo '</div>';
            echo '</div>'; 
          }
  ...
  <script>
    document.querySelectorAll(".show-description").forEach((item) => {
      item.addEventListener("click", (event) => {
        const description = event.currentTarget.getAttribute("data-title");
