    ...
    <div class="container-fluid">
      ...
      <div
        ...
        <div class="navbar-nav ml-auto">
          ...
          <a href="hobby.php" class="nav-item nav-link active">Hobby</a>
  ...
  <div class="service" id="service">
    <div class="container">
      <div
        ...
        data-wow-delay="0.1s">
        <p>What do I like?</p>
        <h2>Discover My World of Hobbies</h2>
      </div>
      <div class="row">
        <?php
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="col-lg-6 wow fadeInUp" data-wow-delay="' . htmlspecialchars($row['delay']) . '">';
            echo '<div class="service-item">';
            echo '<div class="service-icon">';
            echo '<i class="fa ' . htmlspecialchars($row['icon_class']) . '"></i>';
            echo '</div>';
